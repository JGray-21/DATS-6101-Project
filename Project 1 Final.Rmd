...
The polviews variable in the GSS dataset is coded as Extremely Liberal, Liberal, Slightly Liberal, Moderate, Slightly Conservativ, Conservative, and Extremely Conservative.
...
gss74_80$polviews <- factor(gss74_80$polviews, 
                            levels = c(1, 2, 3, 4, 5, 6, 7),  # Adjust based on your actual data
