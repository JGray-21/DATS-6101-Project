...
gss18_22$income <- case_when(
  ...
  gss18_22$income == 6 ~ 'Lower Middle',
  gss18_22$income == 7 ~ 'Lower middle',
  gss18_22$income == 8 ~ 'Lower Middle',
  gss18_22$income == 9 ~ 'Lower Middle',
  gss18_22$income == 10 ~ 'Lower Middle',
  gss18_22$income == 11 ~ 'Middle',
  gss18_22$income == 12 ~ 'Middle',
  gss18_22$income == 13 ~ 'Middle',
  gss18_22$income == 14 ~ 'Middle',
  gss18_22$income == 15 ~ 'Middle',
  gss18_22$income == 16 ~ 'Upper Middle',
  gss18_22$income == 17 ~ 'Upper Middle',
  gss18_22$income == 18 ~ 'Upper Middle',
  gss18_22$income == 19 ~ 'Upper Middle',
  gss18_22$income == 20 ~ 'Upper Middle',
  gss18_22$income == 21 ~ 'Upper Middle',
  gss18_22$income == 22 ~ 'High',
  gss18_22$income == 23 ~ 'High',
